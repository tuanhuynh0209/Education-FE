...
const EditScientificResTpc = () => {
    const { tpcId } = useParams();
    ...
    useEffect(() => {
        const fetchOldData = async () => {
            ...
            try {
                const response = await axios.get(`http://localhost:3001/education/getDataTpc/${tpcId}`);
    ...
    // hàm call api chỉnh sửa Topic
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`http://localhost:3001/education/editDataTpc/${tpcId}`, formData);
            ...
            <form onSubmit={handleSubmit} className='w-full h-full p-10 bg-white shadow-lg rounded-lg'>
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <input
                            type="number"
                            name='so_luong_thanh_vien_vai_tro'
                            value={formData.so_luong_thanh_vien_vai_tro}
                            onChange={handleInputChange}
                            className="bg-slate-100 rounded-lg p-4 outline-none border border-gray-300"
...
export default EditScientificResTpc